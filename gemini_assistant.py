...
class GeminiAssistant:
    ...
    def generate_natural_response(self, user_query: str, search_results: List[Dict], context: str = "") -> str:
        """Gera resposta natural em português com exemplos de código"""
        
        # Prepara o contexto dos resultados da busca
        search_context = ""
        ...
        - Explicação clara do conceito em português
        - Sintaxe da função (se aplicável)
        - Exemplo prático de uso
        - Dicas de aplicação no mundo real
    ...
    def generate_code_example(self, function_name: str, search_results: List[Dict]) -> str:
        """Gera exemplos de código específicos para uma função"""
